...
TEEGradPotentialRecWLS::TEEGradPotentialRecWLS(TPZCompMesh *cmesh, SimulationData simul) : TErrorEstimator(cmesh, simul) {
}
TEEGradPotentialRecWLS::~TEEGradPotentialRecWLS() {
}

/* Function as error estimator for each element */
REAL TEEGradPotentialRecWLS::RecoveredGradient(TPZCompEl *cel) {
...
int TEEGradPotentialRecWLS::ComputingEstimationsByElement(TPZCompEl *cel, TPZVec<REAL> &Estimatives) {
