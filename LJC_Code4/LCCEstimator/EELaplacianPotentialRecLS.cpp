...
TEELaplacianPotentialRecLS::TEELaplacianPotentialRecLS(TPZCompMesh *cmesh, SimulationData simul) : TErrorEstimator(cmesh, simul) {
}
TEELaplacianPotentialRecLS::~TEELaplacianPotentialRecLS() {
}

/* Function as error estimator for each element */
REAL TEELaplacianPotentialRecLS::RecoveredGradient(TPZCompEl *cel) {
...
int TEELaplacianPotentialRecLS::ComputingEstimationsByElement(TPZCompEl *cel, TPZVec<REAL> &Estimatives) {
