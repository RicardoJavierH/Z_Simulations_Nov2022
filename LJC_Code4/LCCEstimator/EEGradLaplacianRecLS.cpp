...
TEEGradLaplacianRecLS::TEEGradLaplacianRecLS(TPZCompMesh *cmesh, SimulationData simul) : TErrorEstimator(cmesh,simul) {
}
TEEGradLaplacianRecLS::~TEEGradLaplacianRecLS() {
}

/* Function as error estimator for each element */
REAL TEEGradLaplacianRecLS::RecoveredGradient(TPZCompEl *cel) {
...
int TEEGradLaplacianRecLS::ComputingEstimationsByElement(TPZCompEl *cel, TPZVec<REAL> &Estimatives) {
