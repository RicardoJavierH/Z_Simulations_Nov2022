...
TEELaplacianPotentialRecWLS::TEELaplacianPotentialRecWLS(TPZCompMesh *cmesh, SimulationData simul) : TErrorEstimator(cmesh, simul) {
}
TEELaplacianPotentialRecWLS::~TEELaplacianPotentialRecWLS() {
}

/* Function as error estimator for each element */
REAL TEELaplacianPotentialRecWLS::RecoveredGradient(TPZCompEl *cel) {
...
int TEELaplacianPotentialRecWLS::ComputingEstimationsByElement(TPZCompEl *cel, TPZVec<REAL> &Estimatives) {
