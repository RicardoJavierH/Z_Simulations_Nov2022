...
public:
  ...
  void Coarsing(TPZStack<int64_t> &Elements,TPZStack<int64_t> &Coarsed);
	...
	void UniformHRefineSelection(TPZStack<int64_t>& indexfathers,int maxhref,bool neigh=true);
	...
	// P refinement
	void UniformPRefinementSelectionIncrement(TPZStack<int64_t>& indextoprefine,int MaxPRefine);
